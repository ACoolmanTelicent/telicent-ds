...
<TeliButton aria-label="send" variant="basic">
  <FontAwesomeIcon icon={faSend} />
      ...
      `}}}},q=h,T={render:()=>t.jsxs("div",{className:"grid grid-rows-1 grid-cols-4 gap-4",children:[t.jsx(e,{variant:"primary",color:"danger",children:"Danger Primary"}),t.jsx(e,{variant:"primary",color:"danger",disabled:!0,children:"Danger Primary"})]}),parameters:{docs:{description:{story:`
...
<TeliButton variant="link" href="#link" disabled>
  Disabled with href
      ...
      `}}}},H=y,B={render:()=>t.jsxs("div",{className:"grid grid-rows-1 grid-cols-4 gap-4",children:[t.jsx(e,{variant:"tertiary",children:"Tertiary"}),t.jsx(e,{variant:"tertiary",disabled:!0,children:"Disabled Tertiary"})]}),parameters:{docs:{description:{story:`
...
<TeliButton variant="tertiary" disabled>
  Disabled Tertiary
      ...
      `}}}},J=B,g={render:()=>t.jsxs("div",{className:"grid grid-rows-1 grid-cols-4 gap-4",children:[t.jsx(e,{variant:"secondary",children:"Secondary"}),t.jsx(e,{variant:"secondary",disabled:!0,children:"Disabled secondary"})]}),parameters:{docs:{description:{story:`
...
<TeliButton variant="secondary" disabled>
  Disabled secondary
      ...
      `}}}},K=g,v={render:()=>t.jsxs("div",{className:"grid grid-rows-1 grid-cols-4 gap-4",children:[t.jsx(e,{variant:"primary",children:"Primary"}),t.jsx(e,{variant:"primary",disabled:!0,children:"Disabled Primary"})]}),parameters:{docs:{description:{story:`
...
>
  Bottom end
      ...
      `}}}},V=x,Y={component:e,parameters:{docs:{source:{type:"dynamic"}}}},r={args:{children:"Default button",onClick:()=>alert("Clicked default button")}};var a,s,l,c,d;r.parameters={...r.parameters,docs:{...(a=r.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
...
refer to the MUI and MDN documentation for a full list of props`,...(d=(c=r.parameters)==null?void 0:c.docs)==null?void 0:d.description}}};const Z=["Basic","PrimaryButtons","SecondaryButtons","TertiaryButtons","LinkButtons","DangerButtons","ButtonsWithIcons","IconButtons","Sizes","ButtonsWithTooltips"];export{r as Basic,_ as ButtonsWithIcons,V as ButtonsWithTooltips,G as DangerButtons,q as IconButtons,H as LinkButtons,Q as PrimaryButtons,K as SecondaryButtons,X as Sizes,J as TertiaryButtons,Z as __namedExportsOrder,Y as default};
